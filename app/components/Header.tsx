      ...
      <div className="container mx-auto flex justify-between items-center px-4 py-3 h-full">
        ...
        <Link href="/" className="flex items-center">
          <div className="relative w-auto">
            <Image
              ...
              width={160} // Adjust to the desired width
              height={80} // Adjust to the desired height
        ...
        <div className="flex items-center space-x-6">
          ...
          >
            ...
            {/* Badge */}
            {cartCount > 0 && (
              <span className="absolute -top-2 right-8 bg-red-500 text-white text-xs font-bold px-1.5 py-0.5 rounded-full">
                {cartCount}
              </span>
            )}
          </div>
          ...
          <Link
            href="/sign-in"
            className={`px-4 py-2 border rounded-md hover:bg-green-600 hover:text-white transition ${buttonClass}`}
          >
            Sign In
          </Link>
        </div>
